...
const DATABASE = {
    destinations: [
        {"id": 1, "name": "Taj Mahal", "country": "India", "continent": "Asia", "lat": 27.1751, "lng": 78.0421, "category": "Historical", "rating": 4.9, "description": "Magnificent ivory-white marble mausoleum, UNESCO World Heritage Site", "imageUrl": "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=800"},
...
function initializeMap() {
    ...
    try {
        ...
        directionsRenderer = new google.maps.DirectionsRenderer({
            polylineOptions: { strokeColor: '#00bcd4', strokeWeight: 4 }
        });
        ...
        const infoWindow = new google.maps.InfoWindow({
            content: `
                <div style="padding: 10px; max-width: 200px;">
                    <h3 style="margin: 0 0 8px 0; color: #333;">${destination.name}</h3>
                    <p style="margin: 0 0 8px 0; color: #666; font-size: 14px;">${destination.country}</p>
                    <div style="display: flex; align-items: center; gap: 4px; margin-bottom: 8px;">
                        <span style="color: #ffa726;">⭐</span>
                        <span style="font-weight: 500;">${destination.rating}</span>
                    </div>
                    <p style="margin: 0; color: #666; font-size: 13px; line-height: 1.4;">${destination.description}</p>
                </div>
            `
        });
